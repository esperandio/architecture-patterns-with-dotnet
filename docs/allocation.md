...
The purchasing department orders small batches of stock. A batch of stock has a unique ID called reference, a SKU, and a quantity.
...
- We have a batch of 1 BLUE-CUSHION, and a order line for 2 BLUE-CUSHION.
...
Batches have an ETA (estimated time to arrival) if they are currently shipping, or they may be in warehouse stock. We allocate to warehouse stock in preference to shipment batches. We allocate to shipment batches in order of which has the earliest ETA.